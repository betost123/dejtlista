...
export const CrownIcon: React.FunctionComponent<Props> = ({
  color = "white",
}) => (
  <svg
    width='24'
  ...
  >
    ...
    />
    <path
      d='M19.5 14.9691V10.9087L16.7811 13.6277L12.0005 8.84717L7.21997 13.6277L4.5 10.9077V14.9691C4.5 15.5214 4.94771 15.9691 5.5 15.9691H18.5C19.0523 15.9691 19.5 15.5214 19.5 14.9691Z'
      fill='#87FF5D'
    />
  </svg>
);
